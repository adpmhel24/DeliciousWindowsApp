...
class OrdersAPI {
  ...
  Future<Response> getCommentByOrderId(String token,
      {required int orderId}) async {
    Response response;
    try {
      response = await dio.get('/api/ordering/comments/get_all/$orderId',
          options: Options(headers: {
            "Authorization": "Bearer " + token,
          }));
    } on DioError catch (e) {
  ...
  Future<Response> getOrderAttachmentByOrderId(String token,
      {required int orderId}) async {
    Response response;
    try {
      response = await dio.get('/api/ordering/attachments/$orderId',
          options: Options(headers: {
            "Authorization": "Bearer " + token,
          }));
    } on DioError catch (e) {
